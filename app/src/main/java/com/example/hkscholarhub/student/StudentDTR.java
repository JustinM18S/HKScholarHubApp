    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                ...
                Intent homeIntent = new Intent(StudentDTR.this, StudentHomePage.class);
                startActivity(homeIntent);
                return true;
            } else if (itemId == R.id.nav_dtr) {
                // Stay on the current DTRActivity
                return true;  // No action needed
            } else if (itemId == R.id.nav_profile) {
                // Navigating to ProfileActivity
                Intent profileIntent = new Intent(StudentDTR.this, StudentProfile.class);
